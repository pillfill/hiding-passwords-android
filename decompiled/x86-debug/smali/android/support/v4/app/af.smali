...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;Landroid/view/View;)Ljava/lang/Object;
    ...
    invoke-static {p2, p1}, Landroid/support/v4/app/af;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/app/af;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/app/ak;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/app/ai;-><init>(Landroid/support/v4/app/ak;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/support/v4/app/af;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v0

    new-instance v1, Landroid/support/v4/app/ag;

    invoke-direct {v1, v0}, Landroid/support/v4/app/ag;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/al;Landroid/view/View;Landroid/support/v4/app/ak;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 10
    ...
    invoke-static {p1, v0}, Landroid/support/v4/app/af;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v1 .. v8}, Landroid/support/v4/app/ah;-><init>(Landroid/view/View;Landroid/support/v4/app/al;Ljava/util/Map;Ljava/util/Map;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    :cond_3
    invoke-static {v6, p5}, Landroid/support/v4/app/af;->a(Landroid/transition/Transition;Landroid/support/v4/app/ak;)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/app/af;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_0
    invoke-static {p0}, Landroid/support/v4/app/af;->a(Landroid/transition/Transition;)Z
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/app/af;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/app/af;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/app/af;->a(Ljava/util/List;)Z
...
.method static synthetic b(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Landroid/support/v4/app/af;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/app/af;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v1}, Landroid/support/v4/app/af;->a(Ljava/util/List;)Z
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/app/af;->b(Ljava/util/ArrayList;Landroid/view/View;)V
