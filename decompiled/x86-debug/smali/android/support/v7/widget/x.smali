...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Landroid/support/v7/widget/x;->a:[I
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/widget/x;->setInternalBackgroundTint(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/x;->setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/internal/widget/be;
    ...
    invoke-static {p0, v1}, Landroid/support/v7/widget/x;->a(Landroid/widget/Spinner;Landroid/graphics/drawable/Drawable;)V
...
.method private a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->c:Landroid/support/v7/internal/widget/bd;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/internal/widget/bd;
...
.method private setInternalBackgroundTint(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/internal/widget/bd;
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/x;->setInternalBackgroundTint(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundResource(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/internal/widget/be;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->c:Landroid/support/v7/internal/widget/bd;
