...
.method private parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    new-instance v7, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;

    invoke-direct {v7, p0, p3}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;-><init>(Landroid/support/v7/internal/view/SupportMenuInflater;Landroid/view/Menu;)V
    ...
    invoke-virtual {v7, p2}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->readGroup(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v7, p2}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->readItem(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->addSubMenuItem()Landroid/view/SubMenu;

    move-result-object v3

    invoke-direct {p0, p1, p2, v3}, Landroid/support/v7/internal/view/SupportMenuInflater;->parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    invoke-virtual {v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->resetGroup()V
    ...
    invoke-virtual {v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->hasAddedItem()Z
    ...
    invoke-static {v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->access$000(Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;)Landroid/support/v4/view/ActionProvider;
    ...
    :cond_9
    invoke-virtual {v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->addItem()V
