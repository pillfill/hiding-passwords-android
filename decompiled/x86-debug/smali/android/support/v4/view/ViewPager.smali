...
.field private static final ah:Landroid/support/v4/view/dh;
...
.field private Q:Landroid/support/v4/widget/t;

.field private R:Landroid/support/v4/widget/t;
...
.field private aa:Landroid/support/v4/view/dd;

.field private ab:Landroid/support/v4/view/dd;

.field private ac:Landroid/support/v4/view/dc;

.field private ad:Landroid/support/v4/view/de;
...
.field private n:Landroid/support/v4/view/df;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ah:Landroid/support/v4/view/dh;
...
.method private a(Landroid/support/v4/view/da;ILandroid/support/v4/view/da;)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v0}, Landroid/support/v4/view/bo;->a()I
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v5, v2}, Landroid/support/v4/view/bo;->a(I)F
    ...
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    add-int/lit8 v2, v1, -0x1

    invoke-virtual {v9, v1}, Landroid/support/v4/view/bo;->a(I)F
...
.method private b(IFI)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/dd;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/dd;

    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/dd;->a(IFI)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/dd;
...
.method private b(Z)V
    ...
    invoke-static {v4, v0, v5}, Landroid/support/v4/view/bv;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private b(F)Z
    ...
    invoke-virtual {v9}, Landroid/support/v4/view/bo;->a()I
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/t;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/t;->a(F)Z
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/t;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/widget/t;->a(F)Z
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->h()Landroid/support/v4/view/da;
...
.method private e(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/dd;->a(I)V
...
.method private f(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/dd;->b(I)V
...
.method private g()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ah:Landroid/support/v4/view/dh;
...
.method private h()Landroid/support/v4/view/da;
    .locals 13
    ...
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget v7, v0, Landroid/support/v4/view/da;->b:I

    invoke-virtual {v6, v7}, Landroid/support/v4/view/bo;->a(I)F
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/de;
...
.method a(II)Landroid/support/v4/view/da;
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v1, p0, p1}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/view/bo;->a(I)F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/da;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;
...
.method a()V
    ...
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget-object v9, v0, Landroid/support/v4/view/da;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Landroid/support/v4/view/bo;->a(Ljava/lang/Object;)I
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v4, p0}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/view/bo;->b(Landroid/view/ViewGroup;)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/db;->a:Z

    if-nez v6, :cond_7

    const/4 v6, 0x0

    iput v6, v0, Landroid/support/v4/view/db;->c:F
...
.method a(I)V
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v5, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v5}, Landroid/support/v4/view/bo;->a()I
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;
    ...
    invoke-virtual {v4, v0, v5, v2}, Landroid/support/v4/view/bo;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bo;->b(Landroid/view/ViewGroup;)V
    ...
    iput v4, v2, Landroid/support/v4/view/db;->f:I

    iget-boolean v7, v2, Landroid/support/v4/view/db;->a:Z

    if-nez v7, :cond_8

    iget v7, v2, Landroid/support/v4/view/db;->c:F
    ...
    iput v7, v2, Landroid/support/v4/view/db;->c:F

    iget v6, v6, Landroid/support/v4/view/da;->b:I

    iput v6, v2, Landroid/support/v4/view/db;->e:I
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget-object v2, v2, Landroid/support/v4/view/da;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v15, v0, v9, v2}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v11, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget-object v2, v2, Landroid/support/v4/view/da;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v11, v0, v9, v2}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
...
.method protected a(IFI)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/db;->a:Z
    ...
    :cond_1
    iget v0, v0, Landroid/support/v4/view/db;->b:I
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/de;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/de;->a(Landroid/view/View;F)V
...
.method a(III)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/view/bo;->a(I)F
...
.method protected a(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bv;->a(Landroid/view/View;I)Z
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/db;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/db;->d:Z
...
.method d()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/bo;->a()I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/bv;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/bo;->a()I
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/t;

    invoke-virtual {v4, v2, v3}, Landroid/support/v4/widget/t;->a(II)V

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/t;

    invoke-virtual {v2, p1}, Landroid/support/v4/widget/t;->a(Landroid/graphics/Canvas;)Z
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/t;
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/t;

    invoke-virtual {v4, v3, v2}, Landroid/support/v4/widget/t;->a(II)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/t;->b()V
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/db;->f:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v3, v5}, Landroid/support/v4/view/bo;->a(I)F
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v7, v1, Landroid/support/v4/view/db;->a:Z

    if-eqz v7, :cond_5

    iget v7, v1, Landroid/support/v4/view/db;->b:I

    and-int/lit8 v7, v7, 0x7

    iget v1, v1, Landroid/support/v4/view/db;->b:I
    ...
    iget-boolean v10, v1, Landroid/support/v4/view/db;->a:Z
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/db;->d:Z

    if-eqz v12, :cond_1

    const/4 v12, 0x0

    iput-boolean v12, v1, Landroid/support/v4/view/db;->d:Z

    int-to-float v12, v7

    iget v1, v1, Landroid/support/v4/view/db;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/db;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/db;->b:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/db;->a:Z
    ...
    iget v0, v0, Landroid/support/v4/view/db;->c:F
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bo;->b()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bq;->a(Landroid/view/VelocityTracker;I)F
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/t;
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/t;->c()Z
...
.method public setAdapter(Landroid/support/v4/view/bo;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/df;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/bo;->b(Landroid/database/DataSetObserver;)V

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    invoke-virtual {v0, p0}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget v4, v0, Landroid/support/v4/view/da;->b:I

    iget-object v0, v0, Landroid/support/v4/view/da;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Landroid/support/v4/view/bo;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/df;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/cx;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/df;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/df;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/bo;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/bo;->a()I
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v4/view/bo;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/dc;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/dc;->a(Landroid/support/v4/view/bo;Landroid/support/v4/view/bo;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/dc;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/dc;

    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/dd;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/dd;
